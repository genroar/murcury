  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "ms-2", children: splitUrl === "login" ? "Login with Google" : "Sign up with Google" })
      ]
    }
  );
}
function Spinner() {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { role: "status", children: [
    /* @__PURE__ */ jsxs(
      "svg",
      {
        "aria-hidden": "true",
